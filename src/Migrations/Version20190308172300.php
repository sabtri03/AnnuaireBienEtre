 ...
 */
final class Version20190308172300 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE internship (id INT AUTO_INCREMENT NOT NULL, organizer_id INT DEFAULT NULL, show_date DATETIME DEFAULT NULL, show_until DATETIME DEFAULT NULL, begin DATETIME DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, end DATETIME DEFAULT NULL, more_info VARCHAR(255) DEFAULT NULL, name VARCHAR(255) NOT NULL, price VARCHAR(255) DEFAULT NULL, INDEX IDX_10D1B00C876C4DDA (organizer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE provider (id INT NOT NULL, profil_id INT DEFAULT NULL, email_contact VARCHAR(255) NOT NULL, name VARCHAR(255) DEFAULT NULL, phone_numb VARCHAR(255) DEFAULT NULL, tva_numb VARCHAR(255) DEFAULT NULL, website VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_92C4739C275ED078 (profil_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE service (id INT AUTO_INCREMENT NOT NULL, description VARCHAR(255) DEFAULT NULL, in_front TINYINT(1) DEFAULT NULL, name VARCHAR(255) NOT NULL, validity TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE provider ADD CONSTRAINT FK_92C4739C275ED078 FOREIGN KEY (profil_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE provider DROP FOREIGN KEY FK_92C4739C275ED078');
